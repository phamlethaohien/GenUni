<template>
  <div class="qa">
    <div class="container">
      <h3 class="text-center" style="margin-top: 20px">Chào mừng bạn đến với không gian</h3>
      <img src="https://i.pinimg.com/originals/b8/9a/22/b89a22f1e76528ed333e962719167322.png" alt="" style=" display: block; margin-left: auto; margin-right: auto; width: 180px; height: 200px;">
      <h2 class="text-center">tại GenUni - nơi cùng nhau giải quyết mọi bài tập!</h2>
    </div>
